    ...
    <HomeContainer>
      <ImageAndTextContainer>
        ...
        <TextColumn>
          ...
          <StyledHeading>Ajude José Inácio a não se atrasar </StyledHeading>
          <StyledParagraph>
            <div>
            Zé Inácio é uma pessoa que se incomoda muito com atrasos. Em um dia específico, enquanto estava na estrada, seu caminhão VW branco, carinhosamente chamado de Bernardão, quebrou. Como ele possui um ótimo conhecimento em mecânica, ele mesmo fez o reparo na embreagem utilizando uma haviana de seu filho, que estava acompanhando-o nessa viagem, para evitar maiores atrasos.
